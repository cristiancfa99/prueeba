...
def listar_peliculas():
    ...
    if conn:
        ...
        if año_busqueda:
            query += ' AND año = %s'  # Asegúrate de que este sea el nombre correcto de la columna
            params.append(año_busqueda)

        cursor.execute(query, params)
        peliculas = cursor.fetchall()
        conn.close()
        return render_template('listar_peliculas.html', peliculas=peliculas, titulo=titulo_busqueda, año=año_busqueda)
